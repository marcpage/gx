#ifndef __Intrinsic64BitInteger_h__
#define __Intrinsic64BitInteger_h__

#include "gxIntrinsicInteger.h"
#include <stdint.h> ///< For int64_t

class Intrinsic64BitInteger : public IntrinsicInteger {
	public:
		typedef int64_t	Integer;
		Intrinsic64BitInteger(Integer instanceValue);
		Integer value() const;
	...
	protected:
		virtual ~Intrinsic64BitInteger() {}
		virtual GenericInstance *clone();
	private:
		Integer	_value;
};

#endif // __Intrinsic64BitInteger_h__
