#ifndef __Integer64Bit_h__
#define __Integer64Bit_h__

#include "gxInteger.h"

class Integer64Bit : public Integer {
	public:
		enum Members {
			kCountOfMembers
		};
		...
		static void init();
		Integer64Bit(int64_t value);
		Integer64Bit(GenericInstance *instance= NULL, Pointer::RetainAction action= Retain);
		~Integer64Bit() {}
